...
2. 남을 향한 자존심 버리고 나를 향한 자존감 키우기!<br>
   사람마다 배움의 속도는 다릅니다. 나만의 속도를 찾는 것이 중요합니다! 자신보다 잘해보이는 사람일지라도 때로는 내가 그 사람에게 도움이 될 수 있습니다. <br>

   > 한 주 동안 챌린지를 진행하면서 나로 인해 도움이 된 내용과 남들로부터 도움 받은 내용을 정리하기 <br>
   > 수정 이유 : 남들에게 도움이 직접적으로 주면 자존감을 키울 수 있기 때문에
...
3. 성장하기 위한 의식적인 수련!<br>
   ...
   > 자신이 사용하는 IDE 단축키 배워서 피어세션에 간략히 소개하기 <br>
   > 수정 이유 : 피드백을 문서로 정리한다는 것이 애매하다.

4. 얻어갈 나만의 목표와 피드백!<br>

   > 학습 정리 내용으로 새로 알게된 지식 공유하기 (피어세션, 슬랙 등등) <br>
   > 수정 이유 : 나만의 체크포인트는 기존 미션에서 이미 작성하고 있다.
...
- Q1: J002\_강유진
- 미션: 내가 이 구역의 질문왕!
- 나만의 목표: 피어세션 전날에 진행한 미션에 대해 궁금한 점이 무엇이 있을지, 좋은 질문인지 고민해보기!
- 수행 내역
  - Day17 피어세션:
    - Question 1.설계를 짤 때, 검증 단계를 어떻게 넣으시는지
    - Question 2.기능적 측면에서 성능과 멀티 유저를 따지면 어떻게 구현할 수 있을지 
  - Day19 피어세션:
    - Question 1.chat 기능 사용 방법을 어떻게 설계하셨는지
    - Question 2.checkin 했을 때, 그룹 매칭 방법을 어떻게 설계하셨는지
  - Day20 피어세션:
    - Question 1.슬랙을 보다보니 임계영역에 대한 얘기가 있던데 아직 처리하지 못했고, 방법을 잘 모르겠어서 해당 부분에 대한 아이디어를 얻는다던가 다른 분들의 생각이 어떠신지 질문하고 싶다!
    - Question 2.JSON, HTTP 처리를 제대로 하지 못해서, 다른 분들은 구현하셨는지 여쭤보고 싶다. 질문을 통해 아이디어를 얻어보고 싶다!
- 느낀점
  - 피어세션을 지금까지 해오면서 생각지 못한 사항을 들으면서, 좋은 질문을 던지는게 중요하다는 생각이 들었다. 직접 질문거리가 무엇이 있을지 생각하면서 좋은 질문이란 무엇일까 고민했다. 그 과정에서 한 번 더 미션 내용과 이론적인 부분을 꼼꼼하게 돌아볼 수 있어 좋았다.
